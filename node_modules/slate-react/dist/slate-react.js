(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('slate'), require('immutable'), require('react-dom'), require('react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'slate', 'immutable', 'react-dom', 'react'], factory) :
	(factory((global.SlateReact = {}),global.Slate,global.Immutable,global.ReactDOM,global.React));
}(this, (function (exports,slate,immutable,ReactDOM,React) { 'use strict';
...
function cloneFragment(event, editor) {
  ...
  var encoded = index$3.serializeNode(fragment);
  ...
  var plainText = index$5.serialize(valFromSelection);
...
function getEventTransfer(event) {
  ...
  if (fragment) fragment = index$3.deserializeNode(fragment);
  if (node) node = index$3.deserializeNode(node);
...
function AfterPlugin() {
  ...
  function onPaste(event, editor, next) {
    ...
    if (type == 'text' || type == 'html') {
      ...
      var frag = index$5.deserialize(text, { defaultBlock: defaultBlock, defaultMarks: defaultMarks }).document;
