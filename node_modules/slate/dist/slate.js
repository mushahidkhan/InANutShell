    ...
    value: function getLeaves() {
      ...
      decorations.forEach(function (dec) {
        ...
        if (hasStart && hasEnd) {
          ...
          var length = hasEnd ? end.offset - index$$1 : _this2.text.length - index$$1;
...
var Editor = function () {
  ...
  createClass(Editor, [{
    ...
    value: function call(fn) {
      index(false, 'As of Slate 0.43 the `editor.command(fn)` method has been deprecated, please use `editor.command(fn)` instead.');
