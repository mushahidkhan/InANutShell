...
import { Map as Map$1, List, Record, Set, OrderedSet, is } from 'immutable';
...
Commands$2.insertTextAtRange = function (editor, range, text, marks) {
  ...
  editor.withoutNormalizing(function () {
    if (range.isExpanded) {
      ...
      var startText = editor.value.document.getNode(path);
...
var Editor = function () {
  ...
  createClass(Editor, [{
    ...
    value: function call(fn) {
      warning(false, 'As of Slate 0.43 the `editor.command(fn)` method has been deprecated, please use `editor.command(fn)` instead.');
